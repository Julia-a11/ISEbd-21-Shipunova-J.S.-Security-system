...
namespace StoreHouseWebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Replenishment()
        {
            ...
            ViewBag.Components = APIClient.GetRequest<List<ComponentViewModel>>($"api/storehouse/getcomponents");

            return View();
        }

        [HttpPost]
        public IActionResult Replenishment(int storeHouseId, int componentId, int count)
        {
            ...
            var component = APIClient.GetRequest<List<StoreHouseViewModel>>(
                "api/storehouse/getcomponents").FirstOrDefault(rec => rec.Id == componentId);
